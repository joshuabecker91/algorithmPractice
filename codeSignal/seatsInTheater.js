...
function solution(nCols, nRows, col, row) {
    ...
    // have to add one because you include those directly behind where you are sitting
    console.log(width)
    let height = (nRows - row)
    console.log(height)
    let people = width * height;
    console.log(people);
    return people;
}
